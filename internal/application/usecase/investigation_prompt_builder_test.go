...
// =============================================================================
// InvestigationPromptBuilder Tests - RED PHASE
// These tests define the expected behavior of the InvestigationPromptBuilder
// interface and its implementations.
// All tests should FAIL until the implementation is complete.
// =============================================================================

// Sentinel errors expected to be defined in investigation_prompt_builder.go.
var (
...
// AlertStub represents a minimal alert for testing prompt building.
...
// Stub implementations - to be implemented in investigation_prompt_builder.go.
...
func (b *HighCPUPromptBuilder) BuildPrompt(_ *AlertStub) (string, error) {
...
func (b *DiskSpacePromptBuilder) BuildPrompt(_ *AlertStub) (string, error) {
	return "", errors.New("not implemented")
}
...
func (b *MemoryPromptBuilder) BuildPrompt(_ *AlertStub) (string, error) {
	return "", errors.New("not implemented")
}
...
func (b *OOMPromptBuilder) BuildPrompt(_ *AlertStub) (string, error) {
	return "", errors.New("not implemented")
}
...
func (b *GenericPromptBuilder) BuildPrompt(_ *AlertStub) (string, error) {
	return "", errors.New("not implemented")
}
...
func (r *DefaultPromptBuilderRegistry) Register(_ InvestigationPromptBuilder) error {
	return errors.New("not implemented")
}

func (r *DefaultPromptBuilderRegistry) Get(_ string) (InvestigationPromptBuilder, error) {
	return nil, errors.New("not implemented")
}

func (r *DefaultPromptBuilderRegistry) BuildPromptForAlert(_ *AlertStub) (string, error) {
	return "", errors.New("not implemented")
}
